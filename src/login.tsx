  ...
  return c.html(
    <Layout title="Login">
      ...
      <form id="login" onsubmit="event.preventDefault();">
        ...
        class="rounded-md bg-slate-900 p-4 text-white min-w-full focus:outline-none focus:border-indigo-700 focus:border" />
        <div class="mt-12">
            <p class="hidden text-red-500 text-center mb-4 transition transition-duration-300" id="error"></p>
            ...
            <div class="text-center mt-4">
              <a href="/signup" class="text-blue-500 hover:underline">Don't have an account? Create One!</a>
            </div>
          </div>
      </form>
      </div>
